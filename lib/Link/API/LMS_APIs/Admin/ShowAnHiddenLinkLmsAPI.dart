...
class Showanhiddenlinklmsapi {
  BuildContext context;
  Showanhiddenlinklmsapi(this.context);
  Dio dio = Dio();
  LinkslmsController controller = Get.find<LinkslmsController>();
  ...
  Showanhiddenlinklms({
    ...
    try {
      ...
      String myurl = "$hostPort$updateLmsUrl";
      ...
      if (response.statusCode == 200) {
        ...
        LinksLMSModel lms_files_model =
            LinksLMSModel.fromJson(response.data);
        controller.SetLinks(lms_files_model);
      } else {
