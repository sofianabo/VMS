...
class Showandhiddenfilelmsapi {
  BuildContext context;
  Showandhiddenfilelmsapi(this.context);
  Dio dio = Dio();
  Files_Controller controller = Get.find<Files_Controller>();

  Showandhiddenfilelms({required bool hidden, required id}) async {
    try {
      CancelToken cancelToken = CancelToken();
      Loading_Dialog(cancelToken: cancelToken);
      String myurl = "$hostPort$updateLmsFile";
