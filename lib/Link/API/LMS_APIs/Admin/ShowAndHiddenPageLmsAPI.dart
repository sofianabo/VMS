...
class Showandhiddenpagelmsapi {
  BuildContext context;
  Showandhiddenpagelmsapi(this.context);
  Dio dio = Dio();
  Pageslmscontroller controller = Get.find<Pageslmscontroller>();
  ...
  Showandhiddenpagelms({
    ...
    try {
      ...
      String myurl = "$hostPort$updateLmsPage";
