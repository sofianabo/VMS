...
class Updatetrueorflasequstionapi {
  BuildContext context;
  Updatetrueorflasequstionapi(this.context);
  Dio dio = Dio();

  Trueorfalsecontroller controller = Get.find<Trueorfalsecontroller>();

  Updatetrueorflasequstion({ question, mark, required bool answer ,required bool isEnglish}) async {
