                          ...
                          onChanged: (newValue) {
                            if (newValue != null && newValue != title) {
                              ...
                              WidgetsBinding.instance.addPostFrameCallback((_) {
                                if (type == "gradediag" && newValue != "") {
                                  Get.find<ClassMgmtController>()
                                      .updateFieldError("grade", false);
                                }
                                if (type == "admin" && newValue != "") {
                                  Get.find<ClassMgmtController>()
                                      .updateFieldError("account", false);
                                }
                              });
                              switch (type) {
                                case 'gradediag':
                                  cont.setGeidx(
                                      Get.find<Dropdowngradecontroller>()
                                          .gradess!
                                          .grades!
                                          .firstWhere((grad) =>
                                  ...
                                  break;
                                case 'admin':
                                  Get.find<Virtual_Employee_Controller>()
                                      .setVECUserID(Get.find<
                                              Virtual_Employee_Controller>()
                                          .viraulClasses!
                                          .firstWhere((admin) =>
                                              admin.userName == newValue)
                                          .id);
                                  break;
                              }
                            }
                              ...
                              ? GestureDetector(
                                  onTap: () {
                                    ...
                                    WidgetsBinding.instance
                                      ...
                                      if (type == "gradediag") {
                                        Get.find<ClassMgmtController>()
                                            .updateFieldError("grade", true);
                                      }
                                      if (type == "admin") {
                                        Get.find<ClassMgmtController>()
                                            .updateFieldError("account", true);
                                      }
                                    });
