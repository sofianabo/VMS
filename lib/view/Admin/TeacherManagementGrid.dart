                  ...
                  children: [
                              ...
                              Get.dialog(VMSAlertDialog(
                                ...
                                contents: Container(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Text(
                                          "Do You Want To Delete ${l[index]['name']} Teacher",
                    ...
                    Row(
                      ...
                      children: [
                        Padding(
                          padding: const EdgeInsets.only(top: 5.0),
                          child: Text("${l[index]['type']}",
                              style: Get.theme.primaryTextTheme.bodySmall!
                                  .copyWith(
                                      fontSize: 16,
                                      color: l[index]['type'] == "Full Time"
                                          ? Color(0xff2F9742)
                                          : Get.theme.primaryColor)),
                        ),
                        Padding(
                          padding: const EdgeInsets.only(top: 5.0),
                          child: Text("${l[index]['gender']}",
                              style: Get.theme.primaryTextTheme.bodySmall!
                                  .copyWith(
                                      fontSize: 16,
                                      color: Get.theme.primaryColor)),
                    ...
                    Padding(
                      padding: const EdgeInsets.only(top: 5.0),
                      child: Text("Mobile : ${l[index]['mobile']}",
                    ...
                    Padding(
                      padding: const EdgeInsets.only(top: 5.0),
                      child: Text("Email : ${l[index]['email']}",
                          style: Get.theme.primaryTextTheme.bodySmall!.copyWith(
                            fontSize: 14,
                          )),
                    ),
