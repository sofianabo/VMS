    ...
    return Expanded(
      ...
      children: [
        Container(
          ...
          child: Row(
            children: [
              GetBuilder<Allteacheratendencecontroller>(
                  builder: (controller) {
                    return Column(
                      children: [
                        Row(
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              Padding(
                                padding: const EdgeInsets.only(left: 8.0),
                                child:  selectTeacherDateAttendence(width: w/3.5,),),
                              Padding(
                                padding: const EdgeInsets.only(left: 8.0),
                                child: TextFormSearch(
                                  ...
                                  onchange: (value) {
                                    controller.searchRequestByName(value, controller.classIndex, controller.SubjectIndex,controller.TypeIndex);
                                  },
                                  width: w / 3.5,
                                  radius: 5,
                                  controller: serch,
