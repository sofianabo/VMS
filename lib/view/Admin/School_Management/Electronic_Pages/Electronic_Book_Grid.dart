              ...
              children: [
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Expanded(
                              child: Center(
                                child: SchemaWidget(width: 40, height: 15),
                              ),
                            )
                          ],
                        ),
                ...
                Align(
                    ...
                    child: Image.asset("../../images/labrary3d.png",
                        height: 300,color: Colors.grey.shade400,)),
              ],
            ),
        ...
        itemBuilder: (context, index) {
          return HoverScaleCard(
            child: GestureDetector(
              onTap: () {
                final url = '${getimage}${control.filteredEbook![index].fileId}';
                                    ...
                                    Get.dialog(VMSAlertDialog(
                                      action: [
                                        ButtonDialog(
                                            text: "Delete",
                                            onPressed: () async {
                                              await Delete_E_Book_API(context).Delete_E_Book(Eid: control.filteredEbook![index].id);
                                            },
          ...
          :Center(child: Text("No Electronic Book" , style: Get.theme.textTheme.titleLarge!.copyWith(
          fontSize: 22,
