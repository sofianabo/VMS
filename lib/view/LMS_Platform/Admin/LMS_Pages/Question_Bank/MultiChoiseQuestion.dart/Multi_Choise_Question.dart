...
class Multi_Choise_Question extends StatefulWidget {
  const Multi_Choise_Question({super.key});

  @override
  State<Multi_Choise_Question> createState() => _Multi_Choise_QuestionState();
}

class _Multi_Choise_QuestionState extends State<Multi_Choise_Question> {
  @override
  initState() {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        if (screenWidth > 769)
          GetBuilder<Multi_Choise_Question_Controller>(builder: (controller) {
            return Container(
              width: screenWidth,
        ...
        GetBuilder<Multi_Choise_Question_Controller>(builder: (controller) {
          ...
          return Multi_Choise_Question_Grid();
        }),
      ],
    );
  }
