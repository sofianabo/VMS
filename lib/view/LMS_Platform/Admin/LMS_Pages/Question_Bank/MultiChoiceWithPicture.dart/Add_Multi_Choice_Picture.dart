...
class Add_Multi_Choice_Picture extends StatefulWidget {
  const Add_Multi_Choice_Picture({super.key});

  @override
  State<Add_Multi_Choice_Picture> createState() =>
      _Add_Multi_Choice_PictureState();
}

class _Add_Multi_Choice_PictureState extends State<Add_Multi_Choice_Picture> {
  final TextEditingController Question = TextEditingController();
  final TextEditingController _optionController = TextEditingController();
  final FocusNode _optionFocusNode = FocusNode();
  var cont = Get.find<Multi_Choice_Picture_Controller>();
    ...
    return VMSAlertDialog(
      action: [
        ButtonDialog(
          ...
          onPressed: () async {
            ...
            bool isImageEmpty = cont.selectedImage.value == null;

            cont.updateFieldError("aname", isquestion);
            cont.updateFieldError("image", isImageEmpty);

            if (!(isquestion || isImageEmpty)) {
              ...
              if (cont.validateBeforeSave()) {
                ...
                cont.selectedImage.value!.clear();
                // تم التعديل هنا
              }
            }
          },
      ...
      contents: Container(
        ...
        child: SingleChildScrollView(
          child: GetBuilder<Multi_Choice_Picture_Controller>(
              builder: (controller) {
            return Column(
              children: [
                Textfildwithupper(
