...
class Multi_Choice_Picture_Grid extends StatefulWidget {
  const Multi_Choice_Picture_Grid({super.key});

  @override
  State<Multi_Choice_Picture_Grid> createState() =>
      _Multi_Choice_Picture_GridState();
}

class _Multi_Choice_Picture_GridState
    extends State<Multi_Choice_Picture_Grid> {
  @override
  ...
  Widget _buildQuestionItem(
      ...
      Multi_Choice_Picture_Controller controller,
      int index,
      double screenWidth) {
