...
class Add_Article_question_From_Bank extends StatefulWidget {
  const Add_Article_question_From_Bank({super.key});

  @override
  State<Add_Article_question_From_Bank> createState() =>
      _Add_Article_question_From_BankState();
}

class _Add_Article_question_From_BankState
    extends State<Add_Article_question_From_Bank> {
  @override
  initState() {
  ...
  Widget build(BuildContext context) {
    ...
    return VMSAlertDialog(
      ...
      contents: Container(
        ...
        child: Column(
          children: [
            GetBuilder<Quiz_Articale_Quiz_Controller>(builder: (controller) {
              return Container(
                width: screenWidth,
            ...
            GetBuilder<Quiz_Articale_Quiz_Controller>(builder: (controller) {
              ...
              return Article_Qustion_Grid_From_Bank();
            }),
          ],
        ),
      ),
