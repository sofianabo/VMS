...
import 'package:vms_school/view/LMS_Platform/Admin/LMS_Pages/Quiz_Pages_LMS/Quiz_Question_LMS/Add_Quiz_Dialogs/Add_From_Bank/Matching/Matching_From_Bank_Grid.dart';

class Matching_From_Bank_Managment extends StatefulWidget {
  const Matching_From_Bank_Managment({super.key});

  @override
  State<Matching_From_Bank_Managment> createState() =>
      _Matching_From_Bank_ManagmentState();
}

class _Matching_From_Bank_ManagmentState
    extends State<Matching_From_Bank_Managment> {
  @override
  initState() {
  ...
  Widget build(BuildContext context) {
    ...
    return VMSAlertDialog(
      ...
      contents: Container(
        ...
        child: Column(
          children: [
            GetBuilder<Quiz_Matching_Question_Controller>(
                builder: (controller) {
              return Container(
                width: screenWidth,
            ...
            GetBuilder<Quiz_Matching_Question_Controller>(
              ...
              return Matching_From_Bank_Grid();
            }),
          ],
        ),
      ),
