...
class Linkslmsdropdown extends StatelessWidget {
  final double width;
  final String title;
  final String type;
  ...
  Widget build(BuildContext context) {
    return GetBuilder<LinkslmsController>(builder: (cont) {
      return _buildNormalDropdown(cont, context);
    });
  }

  Widget _buildNormalDropdown(LinkslmsController cont, BuildContext context) {
  ...
  List<DropdownMenuItem<String>> _getDropdownItems(LinkslmsController cont) {
