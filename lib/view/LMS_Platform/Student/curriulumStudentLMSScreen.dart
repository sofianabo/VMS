...
class Curriulumstudentlmsscreen extends StatefulWidget {
  const Curriulumstudentlmsscreen({super.key});

  @override
  State<Curriulumstudentlmsscreen> createState() =>
      _CurriulumstudentlmsscreenState();
}

class _CurriulumstudentlmsscreenState extends State<Curriulumstudentlmsscreen> {
