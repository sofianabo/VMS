...
import 'package:vms_school/view/SMS_Platform/Admin/Students_Manager/Edite_Students_Drop_Files.dart';
...
EditStudentDialog(int idx, BuildContext context) async {
  ...
  TextEditingController PublicRegisterNumber = TextEditingController(
      text: "${Controller.student!.PublicRegisterNumber ?? ""}");
  ...
  Get.dialog(VMSAlertDialog(
            ...
            onPressed: () async {
              ...
              if (!(isFirstNameEmpty ||
                ...
                await Update_Student_API.Update_Student(
                    ...
                    PublicRegisterNumber: PublicRegisterNumber.text,
      ...
      contents: Edite_Students_page(
        ...
        PublicRegisterNumber: PublicRegisterNumber,
...
class Edite_Students_page extends StatefulWidget {
  Edite_Students_page({
    ...
    required this.PublicRegisterNumber,
  ...
  TextEditingController Fee_Discount;
  TextEditingController username;
  TextEditingController PublicRegisterNumber;
                              ...
                              Row(
                                children: [
                                  Obx(() => Checkbox(
                                        ...
                                        onChanged: (value) {
                                          controller.toggleSpecialNeed(value!);
                                        },
                                      )),
                                ...
                                if (!controller.isPendStudent.value) {
                                  Get.defaultDialog(
                                    ...
                                    confirm: ElevatedButton(
                                      ...
                                      child: Text("Yes".tr),
                                      style: ElevatedButton.styleFrom(
                                          backgroundColor: Color(0xffB03D3D),
                    ...
                    Wrap(
                      ...
                      children: [
                        ...
                        Textfildwithupper(
                            isRequired: false,
                            width: smallwidth,
                            controller: widget.PublicRegisterNumber,
