                                  ...
                                  children: [
                                    SizedBox(
                                      ...
                                      child: Text(
                                          ...
                                          "${Get.find<LocalizationController>().currentLocale.value.languageCode == 'ar' ? control.filteredTransaction![index].arDetail : control.filteredTransaction![index].detail}",
                                          style: Theme.of(context)
                                              .textTheme
                                              .bodyMedium!
                                              .copyWith(
