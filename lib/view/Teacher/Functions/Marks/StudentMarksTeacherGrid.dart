...
class Studentmarksteachergrid extends StatefulWidget {
...
class _StudentmarksteachergridState extends State<Studentmarksteachergrid> {
    ...
    return Directionality(
      textDirection:
          Get.find<LocalizationController>().currentLocale.value.languageCode ==
              ...
              ? TextDirection.rtl
              : TextDirection.ltr,
      child: GetBuilder<StudentmarksTeachercontroller>(builder: (controller) {
  ...
  double _calculateTotalWidth(StudentmarksTeachercontroller controller) {
  ...
  Widget _buildHeaderTable(
      BuildContext context, StudentmarksTeachercontroller controller) {
    return Table(
      ...
      children: controller.filterdstudent!.map((student) {
        return TableRow(
          children: [
            ...
            ...controller.studentsMarksModel!.quizType!.map((quizType) {
              return GetBuilder<StudentmarksTeachercontroller>(
                builder: (controller) =>
        ...
        return TextField(
          ...
          onChanged: (value) {
            if (mark != null) {
              ...
              final ctrl = Get.find<StudentmarksTeachercontroller>();
  ...
  Widget _buildOptionsButton(Student student) {
    var controller = Get.find<StudentmarksTeachercontroller>();
    return Container(
      width: 40,
      height: 40,
      alignment: Alignment.center,
      child: IconButton(
        ...
        onPressed: () async {
          AddstudentmarksTeacherapi().saveSingleStudent(
  ...
  Map<int, TableColumnWidth> _buildColumnWidths(
      StudentmarksTeachercontroller controller) {
  ...
  void _initFocusNodesAndControllers(StudentmarksTeachercontroller controller) {
  ...
  Widget tableCellWithItems(BuildContext context, List<Items> items, int index,
    ...
    return Container(
      width: double.parse(Get.find<StudentmarksTeachercontroller>()
          .studentsMarksModel!
          .quizType![index]
          .size
          .toString()),
  ...
  Widget tableCell(BuildContext context, String text, int index,
    ...
    return Container(
      width: index == -1
          ? 150
          : double.parse(Get.find<StudentmarksTeachercontroller>()
              .studentsMarksModel!
              .quizType![index]
              .size
              .toString()),
